...
![Figure 2: FreeRTOS Task Architecture and IPC Design](images/task-communication-diagram.jpg)  
*Figure 2: FreeRTOS Task Architecture and Inter-Process Communication Primitives.*
...
4. **`g_systemEvents` (Type: `EventGroupHandle_t`):**  
   ...
   * `EVENT_ACTIVE` $(1 \ll 0)$: Indicates system power state (1 = Active, 0 = Inactive sleep mode).
   * `EVENT_MOTION` $(1 \ll 1)$: Signals presence detection from the PIR sensor.
   * `EVENT_ALARM` $(1 \ll 2)$: Broadcasts that a temperature excursion condition is active.
...
![Figure 3: System Finite State Machine and Power Management](images/state-machine-diagram.png)  
*Figure 3: Finite State Machine and Power Management Flowchart.*
...
![Figure 4: Acoustic Buzzer Alarm Triggered during High Temperature Excursion](images/wokwi-alarm-active.png)  
*Figure 4: Wokwi Simulation Terminal Capturing High Temperature Alarm Triggered at 36.3°C.*
...
![Figure 5: Automated Host-Native Unit Test Execution Results](images/unit-tests-success.png)  
*Figure 5: Terminal Output Demonstrating 13 Passed Unit Tests under the PlatformIO Native Environment.*
...
![Figure 6: Wokwi Environmental Simulation Environment](images/wokwi-simulation-active.png)  
*Figure 6: Complete Wokwi Hardware Simulation Setup with ESP32, DHT22, LDR, PIR, OLED, and Rotary Encoder.*
